    ...
    return (
        <nav className="bg-[#B5FFEC] w-48 h-screen fixed top-0">
            ...
            <div className="flex flex-col my-20">
                ...
                <NavLink to="/appointments" className={({ isActive }) => isActive ? 'py-2 pl-3 pr-23 bg-[#06D6A0] font-bold' : 'py-2 px-3'}>
                ...
                <NavLink to="/messages" className={({ isActive }) => isActive ? 'py-2 pl-3 pr-23 bg-[#06D6A0] font-bold' : 'py-2 px-3'}>
                    <FontAwesomeIcon className="mr-2" icon={faMessage} size="lg" aria-label="Messages" />
                    <p className="inline ml-1">Messaging</p>
                </NavLink>
                <NavLink to="/resources" className={({ isActive }) => isActive ? 'py-2 pl-3 pr-23 bg-[#06D6A0] font-bold' : 'py-2 px-3'}>
                    <FontAwesomeIcon className="mr-2" icon={faLightbulb} size="lg" aria-label="Resources" />
                    <p className="inline ml-2">Resources</p>
                </NavLink>
                <NavLink to="/billing" className={({ isActive }) => isActive ? 'py-2 pl-3 pr-24 bg-[#06D6A0] font-bold' : 'py-2 px-3'}>
                    <FontAwesomeIcon className="mr-2" icon={faCircleDollarToSlot} size="lg" aria-label="Billing" />
                    <p className="inline ml-1">Billing</p>
                </NavLink>
                <NavLink to="/profile" className={({ isActive }) => isActive ? 'py-2 pl-3 pr-24 bg-[#06D6A0] font-bold' : 'py-2 px-3'}>
